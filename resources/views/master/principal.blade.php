...
<html lang="en">
 ...
 {!!Html::style('css/custom.css')!!}
  ...
  <body class="nav-md">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> Registros <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li>
                        <a href="{{url('registro')}}">Área / Oficina</a>
                      </li>
                      <li>
                        <a href="{{route('registro.show','1')}}">Facultad</a>
                      </li>
                      <li>
                        <a href="{{route('registro.show','2')}}">Universidad</a>
                      </li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Cardex <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li>
                        <a href="{{route('cardex.show','0')}}">Registros</a>
                      </li>
                      <li>
                         <a href="{{route('cardex.show','1')}}">Proveidos</a>
                      </li>
                      <li>
                        <a href="{{route('cardex.show','2')}}">Oficios</a>
                      </li>
                      <li>
                        <a href="{{route('cardex.show','3')}}">Oficios Múltiples</a>
                      </li>
                      <li>
                          <a href="{{route('cardex.show','4')}}">Resoluciones de Decanato</a>
                      </li>
                      <li>
                          <a href="{{route('cardex.show','6')}}">Resoluciones de Cons de Fac</a>
                      </li>
                      <li>
                          <a href="{{route('cardex.show','7')}}">Prov comisión de currícula</a>
                      </li>
                      <li>
                          <a href="{{route('cardex.show','5')}}">Otros</a>
                      </li>
                    </ul>
                  </li>

                  @if(Auth::user()->id<16 && Auth::user()->id>0)
                  <li><a><i class="fa fa-cog"></i> Configuraciones<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li>
                        <a href="{{route('oficina.index')}}">Oficinas / Áreas</a>
                      </li>
                    </ul>
                  </li>
                  @endif
    ...
    {!!Html::script('js/soloNuemeros.js')!!}
    @yield('pie')
