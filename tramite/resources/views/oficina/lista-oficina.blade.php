...
@section('contenido')
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Oficinas<a href="{!! route('oficina.create')!!}" id="ico-plus" title="Nuevo"><i class="fa fa-plus-circle"></i></a></h2>
                        ...
                        @if($opcion==0)
                            <tr data-toggle="modal" data-target=".bs-example-modal-lg">
                              ...
                              <td>
                                  ...
                                  <a  href="{{url('eliminar', $oficina->id )}}" 
                                      onclick="javascript:return confirmacion('esta Área / Oficina');" 
